...
var highScoreSnapshot = 'psyii_highscore.s64';
var progressSnapshot = 'psyii_savedgame.s64';
...
var Module = {
    ...
    // Set the preferred joystick port for psyii
    setTimeout(function() { Module.ccall('js_selectJoystick', 'number', ['number', 'number'], [0x00, 0x1D]); }, 5);
